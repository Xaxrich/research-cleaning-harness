# Source Card Review: F_GST_020 - iOS Harness 工作流 5：App Store 发布流
...
|---|---|
| source_id | F_GST_020 |
| source_card | output/source_cards/gstack/F_GST_020_ios_harness_docs_workflow_app_store_release.md |
