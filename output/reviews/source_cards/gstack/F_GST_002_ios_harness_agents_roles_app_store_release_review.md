# Source Card Review: F_GST_002 - Role: App Store Release（发布 Agent）
...
|---|---|
| source_id | F_GST_002 |
| source_card | output/source_cards/gstack/F_GST_002_ios_harness_agents_roles_app_store_release.md |
