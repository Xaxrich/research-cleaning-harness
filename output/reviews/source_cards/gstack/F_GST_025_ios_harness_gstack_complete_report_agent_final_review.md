# Source Card Review: F_GST_025 - gstack 框架深度研究：从虚拟工程团队到 iOS Agent 集群治理
...
|---|---|
| source_id | F_GST_025 |
| source_card | output/source_cards/gstack/F_GST_025_ios_harness_gstack_complete_report_agent_final.md |
