# Source Card Review: F_GST_003 - Role: Firebase Backend（后端 Agent）
...
|---|---|
| source_id | F_GST_003 |
| source_card | output/source_cards/gstack/F_GST_003_ios_harness_agents_roles_firebase_backend.md |
