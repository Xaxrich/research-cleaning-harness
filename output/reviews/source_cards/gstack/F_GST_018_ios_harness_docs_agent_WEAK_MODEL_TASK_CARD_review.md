# Source Card Review: F_GST_018 - iOS Harness Agent 弱模型任务卡模板
...
|---|---|
| source_id | F_GST_018 |
| source_card | output/source_cards/gstack/F_GST_018_ios_harness_docs_agent_WEAK_MODEL_TASK_CARD.md |
