# Source Card Review: F_AID_036 - Superpowers + GSD2 + gstack + Aider 组合方案
...
|---|---|
| source_id | F_AID_036 |
| source_card | output/source_cards/aider/F_AID_036_交付物6_四框架组合方案.md |
| raw_path | raw/Kimi_Agent_Aider 代码库方案/交付物6_四框架组合方案.md |
