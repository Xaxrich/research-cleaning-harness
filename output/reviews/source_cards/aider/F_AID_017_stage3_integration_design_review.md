# Source Card Review: F_AID_017 - iOS Harness 四框架组合方案：Superpowers + GSD2 + gstack + Aider
...
|---|---|
| source_id | F_AID_017 |
| source_card | output/source_cards/aider/F_AID_017_stage3_integration_design.md |
