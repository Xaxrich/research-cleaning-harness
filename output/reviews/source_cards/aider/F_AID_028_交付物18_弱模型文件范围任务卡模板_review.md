# Source Card Review: F_AID_028 - 弱模型文件范围任务卡模板
...
|---|---|
| source_id | F_AID_028 |
| source_card | output/source_cards/aider/F_AID_028_交付物18_弱模型文件范围任务卡模板.md |
| raw_path | raw/Kimi_Agent_Aider 代码库方案/交付物18_弱模型文件范围任务卡模板.md |
