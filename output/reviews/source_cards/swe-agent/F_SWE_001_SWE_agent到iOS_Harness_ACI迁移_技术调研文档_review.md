# Source Card Review: F_SWE_001 - SWE agent到iOS Harness ACI迁移 技术调研文档
...
|---|---|
| source_id | F_SWE_001 |
| source_card | output/source_cards/swe-agent/F_SWE_001_SWE_agent到iOS_Harness_ACI迁移_技术调研文档.md |
