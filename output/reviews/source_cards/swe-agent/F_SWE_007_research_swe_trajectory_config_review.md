# Source Card Review: F_SWE_007 - SWE-agent Trajectory/Replay 体系、配置系统、环境抽象深度研究报告
...
|---|---|
| source_id | F_SWE_007 |
| source_card | output/source_cards/swe-agent/F_SWE_007_research_swe_trajectory_config.md |
