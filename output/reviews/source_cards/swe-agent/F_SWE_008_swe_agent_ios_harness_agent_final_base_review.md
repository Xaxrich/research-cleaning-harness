# Source Card Review: F_SWE_008 - swe agent ios harness.agent.final.base
...
|---|---|
| source_id | F_SWE_008 |
| source_card | output/source_cards/swe-agent/F_SWE_008_swe_agent_ios_harness_agent_final_base.md |
