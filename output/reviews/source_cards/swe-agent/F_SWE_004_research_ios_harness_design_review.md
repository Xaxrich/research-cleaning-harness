# Source Card Review: F_SWE_004 - SWE-agent ACI 到 iOS App Store Harness 的迁移设计研究报告
...
|---|---|
| source_id | F_SWE_004 |
| source_card | output/source_cards/swe-agent/F_SWE_004_research_ios_harness_design.md |
