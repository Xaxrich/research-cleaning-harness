# Source Card Review: F_SWE_009 - SWE-agent / mini-SWE-agent → iOS Harness ACI 迁移：完整技术调研文档
...
|---|---|
| source_id | F_SWE_009 |
| source_card | output/source_cards/swe-agent/F_SWE_009_swe_agent_ios_harness_agent_final_converted.md |
