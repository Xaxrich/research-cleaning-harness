# Source Card Review: F_SWE_005 - SWE-agent Agent-Computer Interface (ACI) 设计机制深度研究报告
...
|---|---|
| source_id | F_SWE_005 |
| source_card | output/source_cards/swe-agent/F_SWE_005_research_swe_aci_mechanisms.md |
