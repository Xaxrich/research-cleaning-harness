# Source Card Review: F_SWE_006 - SWE-agent & mini-SWE-agent 仓库结构与源码组织深度研究报告
...
|---|---|
| source_id | F_SWE_006 |
| source_card | output/source_cards/swe-agent/F_SWE_006_research_swe_repo_structure.md |
