# Source Card Review: F_SWE_012 - SWE-agent / mini-SWE-agent → iOS Harness ACI 迁移：完整技术调研文档
...
|---|---|
| source_id | F_SWE_012 |
| source_card | output/source_cards/swe-agent/F_SWE_012_swe_agent_ios_harness_agent_outline.md |
