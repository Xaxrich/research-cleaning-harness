# Source Card Review: F_SWE_010 - swe agent ios harness.agent.final.footnote
...
|---|---|
| source_id | F_SWE_010 |
| source_card | output/source_cards/swe-agent/F_SWE_010_swe_agent_ios_harness_agent_final_footnote.md |
